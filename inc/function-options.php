...
<?php
  ...
  {
    $true = (isset($this->options['govph_disable_search']) && $this->options['govph_disable_search'] == 'true') ? "checked" : "";
  ?>
...
<?php
  ...
  public function govph_enable_widget_classic_editor(){
    $true = (isset($this->options['govph_enable_widget_classic_editor']) && $this->options['govph_enable_widget_classic_editor'] == 'true' ? "checked" : "");
  ?>
...
<?php
  ...
  public function govph_enable_post_classic_editor(){
    $true = (isset($option['govph_enable_post_classic_editor']) && $this->options['govph_enable_post_classic_editor'] == 'true' ? "checked" : "");
  ?>
...
<?php
  ...
  public function govph_logo_position_setting(){
    $left = (!empty($this->options['govph_logo_position']) && $this->options['govph_logo_position'] == 'left' ? "checked" : "");
    $center = (!empty($this->options['govph_logo_position']) && $this->options['govph_logo_position'] == 'center' ? "checked" : "");
    ?>
  ...
  public function govph_logo_setting() {
    // Use a default value if the option is not set
    $govph_logo = !empty($this->options['govph_logo']) ? esc_url($this->options['govph_logo']) : '';
?>
    <label for="upload_image">
        <input id="upload_image" type="text" size="36" name="govph_options[govph_logo]"
            value="<?php echo $govph_logo; ?>" />
    ...
    <?php if ($govph_logo) : ?>
        <br/><img src="<?php echo $govph_logo; ?>" height="100px" alt="" style="background: #ddd; padding: 10px;">
    <?php endif; ?>
<?php
}
...
<?php
  ...
  {
    $value = isset($this->options['govph_agency_name']) ? $this->options['govph_agency_name'] : '';
  ?>
...
<?php
  ...
  public function govph_header_color_setting() {
    // Use a default value if the option is not set
    $govph_header_color = !empty($this->options['govph_headercolor']) ? $this->options['govph_headercolor'] : '#142745';
?>
    <input name="govph_options[govph_headercolor]" type="text"
        value="<?php echo esc_attr($govph_header_color); ?>" class="my-color-field"
        id="color-field-header-bg" data-default-color="#142745" />
<?php
}
...
<?php
  ...
  public function govph_header_image_setting() {
    // Use a default value if the option is not set
    $govph_headerimage = !empty($this->options['govph_headerimage']) ? esc_url($this->options['govph_headerimage']) : '';
?>
    <label for="header_image_background">
        <input id="header_image_background" type="text" size="36" name="govph_options[govph_headerimage]"
            value="<?php echo $govph_headerimage; ?>" />
    ...
    <?php if ($govph_headerimage) : ?>
        <br/><img src="<?php echo $govph_headerimage; ?>" height="100px" style="background: #ddd; padding: 10px;">
    <?php endif; ?>
<?php
}
  ...
  public function govph_background_header_size_fullwith_setting(){
    $true = (isset($this->options['govph_background_header_size']) == 'true' ? "checked" : "");
    ?>
...
<?php
  ...
  public function govph_slider_color_setting() {
    // Use a default value if the option is not set
    $govph_slider_color = !empty($this->options['govph_slidercolor']) ? $this->options['govph_slidercolor'] : '#1f3a70';
?>
    <input name="govph_options[govph_slidercolor]" type="text"
        value="<?php echo esc_attr($govph_slider_color); ?>" class="my-color-field"
        id="color-field-slider" data-default-color="#1f3a70" />
<?php
}
...
<label for="slider_image_background">
    <input id="slider_image_background" type="text" size="36" name="govph_options[govph_sliderimage]"
        value="<?php echo esc_attr(isset($this->options['govph_sliderimage']) ? $this->options['govph_sliderimage'] : ''); ?>" />
    <input id="slider_image_background_button" class="button" type="button" value="Upload Image" />
    <br /><span class="description">Enter a URL or upload an image for slider background.</span>
</label>
<?php
    if (!empty($this->options['govph_sliderimage'])) {
        echo '<br/><img src="'.esc_url($this->options['govph_sliderimage']).'" height="200px" style="background: #ddd; padding: 10px;">';
    }
}

  public function govph_slider_fullwidth()
  {
    $true = (isset($this->options['govph_slider_fullwidth']) == 'true' ? "checked" : "");
  ?>
...
<?php
  ...
  {
    $true = (isset($this->options['govph_breadcrumbs_enable']) == 'true' ? "checked" : "");
  ?>
...
<?php
  ...
  {
    $value = isset($this->options['govph_breadcrumbs_separator']) ? $this->options['govph_breadcrumbs_separator'] : ' › ';
  ?>
...
<?php
  ...
  {
    $true = (isset($this->options['govph_breadcrumbs_show_home']) == 'true' ? "checked" : "");
  ?>
...
?>
    <input name="govph_options[govph_custom_pst]" type="text"
        value="<?php echo esc_attr($govph_custom_pst); ?>" class="my-color-field"
        id="color-field-pst" data-default-color="#000000" />
...
<?php
  ...
  public function govph_custom_anchorcolor() {
    // Use a default value if the option is not set
    $govph_custom_anchorcolor = !empty($this->options['govph_custom_anchorcolor']) ? $this->options['govph_custom_anchorcolor'] : '#2ba6cb';
?>
    <input name="govph_options[govph_custom_anchorcolor]" type="text"
        value="<?php echo esc_attr($govph_custom_anchorcolor); ?>" class="my-color-field"
        id="color-field-anchor" data-default-color="#2ba6cb" />
...
<?php
  ...
  {
    $govph_custom_anchorcolor_hover =!empty($this->options['govph_custom_anchorcolor_hover']) ? $this->options['govph_custom_anchorcolor_hover'] : '#0643a7';
  ?>
  
<input name="govph_options[govph_custom_anchorcolor_hover]" type="text"
    value="<?php echo esc_attr($govph_custom_anchorcolor_hover); ?>" class="my-color-field"
...
<?php
  ...
  public function govph_custom_panel_top() {
    // Use a default value if the option is not set
    $govph_custom_panel_top = !empty($this->options['govph_custom_panel_top']) ? $this->options['govph_custom_panel_top'] : '#ffffff';
?>
    <input name="govph_options[govph_custom_panel_top]" type="text"
        value="<?php echo esc_attr($govph_custom_panel_top); ?>" class="my-color-field"
        id="color-field-panel-top" data-default-color="#ffffff" />
...
public function govph_custom_panel_bottom() {
  // Use a default value if the option is not set
  $govph_custom_panel_bottom = !empty($this->options['govph_custom_panel_bottom']) ? $this->options['govph_custom_panel_bottom'] : '#ffffff';
?>
  <input name="govph_options[govph_custom_panel_bottom]" type="text"
      value="<?php echo esc_attr($govph_custom_panel_bottom); ?>" class="my-color-field"
      id="color-field-panel-bottom" data-default-color="#ffffff" />
...
{
    $current_value = isset($this->options['govph_custom_border_width']) ? $this->options['govph_custom_border_width'] : '';
    ?>
    <select name="govph_options[govph_custom_border_width]">
        <option value="">-- Select --</option>
        <option value="0" <?php selected($current_value, 0); ?>>0px</option>
        <option value="1" <?php selected($current_value, 1); ?>>1px</option>
        <option value="2" <?php selected($current_value, 2); ?>>2px</option>
        <option value="3" <?php selected($current_value, 3); ?>>3px</option>
        <option value="4" <?php selected($current_value, 4); ?>>4px</option>
        <option value="5" <?php selected($current_value, 5); ?>>5px</option>
    </select>
...
{
    $current_value = isset($this->options['govph_custom_border_radius']) ? $this->options['govph_custom_border_radius'] : '';
    ?>
    <select name="govph_options[govph_custom_border_radius]">
        ...
        <option value="2" <?php selected($current_value, 2); ?>>2px</option>
        <option value="4" <?php selected($current_value, 4); ?>>4px</option>
        <option value="6" <?php selected($current_value, 6); ?>>6px</option>
        <option value="8" <?php selected($current_value, 8); ?>>8px</option>
        <option value="10" <?php selected($current_value, 10); ?>>10px</option>
        <option value="12" <?php selected($current_value, 12); ?>>12px</option>
        <option value="14" <?php selected($current_value, 14); ?>>14px</option>
        <option value="16" <?php selected($current_value, 16); ?>>16px</option>
        <option value="18" <?php selected($current_value, 18); ?>>18px</option>
        <option value="20" <?php selected($current_value, 20); ?>>20px</option>
    </select>
...
<input name="govph_options[govph_custom_border_color]" type="text"
    value="<?php echo esc_attr($govph_custom_border_color); ?>" class="my-color-field"
...
<input name="govph_options[govph_custom_background_color]" type="text"
    value="<?php echo esc_attr($govph_custom_background_color); ?>" class="my-color-field"
...
<?php
  ...
  {
      $nl = (!empty($this->options['govph_custom_headings_text']) && $this->options['govph_custom_headings_text'] == "none" ? "selected" : "");
      $ups = (!empty($this->options['govph_custom_headings_text']) && $this->options['govph_custom_headings_text'] == "uppercase" ? "selected" : "");
      $lws = (!empty($this->options['govph_custom_headings_text']) && $this->options['govph_custom_headings_text'] == "lowercase" ? "selected" : "");
      $caps = (!empty($this->options['govph_custom_headings_text']) && $this->options['govph_custom_headings_text'] == "capitalize" ? "selected" : "");
      ?>
  ...
  {
      $sm = (!empty($this->options['govph_custom_headings_size']) && $this->options['govph_custom_headings_size'] == 0.8 ? "selected" : "");
      $nl = (!empty($this->options['govph_custom_headings_size']) && $this->options['govph_custom_headings_size'] == 1 ? "selected" : "");
      $lr = (!empty($this->options['govph_custom_headings_size']) && $this->options['govph_custom_headings_size'] == 1.6 ? "selected" : "");
      ?>
  ...
  {
      $sm = (!empty($this->options['govph_custom_headings_inner_page_size']) && $this->options['govph_custom_headings_inner_page_size'] == 2 ? "selected" : "");
      $nl = (!empty($this->options['govph_custom_headings_inner_page_size']) && $this->options['govph_custom_headings_inner_page_size'] == 2.69 ? "selected" : "");
      $lr = (!empty($this->options['govph_custom_headings_inner_page_size']) && $this->options['govph_custom_headings_inner_page_size'] == 3.5 ? "selected" : "");
      ?>
...
?>
    <input name="govph_options[govph_custom_footer_background_color]" type="text"
        value="<?php echo esc_attr($govph_custom_footer_background_color); ?>" class="my-color-field"
...
<?php
  ...
  public function govph_content_show_pub_date(){
    $true = (isset($this->options['govph_content_show_pub_date']) == 'true' || !empty($this->options['govph_content_show_pub_date']) ? "checked" : "");
  ?>
...
<?php
  ...
  public function govph_content_show_author(){
    $true = (isset($this->options['govph_content_show_author']) == 'true' ? "checked" : "");
  ?>
...
<?php
  ...
  {
    $value = isset($this->options['govph_acc_link_statement']) ? $this->options['govph_acc_link_statement'] : '';
  ?>
...
<?php
  ...
  {
    $value = isset($this->options['govph_acc_link_home']) ? $this->options['govph_acc_link_home'] : '';
  ?>
<span class="field-prefix"><?php echo get_site_url(); ?>/ </span>
...
<?php
  ...
  {
    $value = isset($this->options['govph_acc_link_main_content']) ? $this->options['govph_acc_link_main_content'] : '#main-content';
  ?>
...
<input type="text" name="govph_options[govph_acc_link_contact]"
    value="<?php echo isset($this->options['govph_acc_link_contact']) ?>">
<?php
  }
...
<input type="text" name="govph_options[govph_acc_link_feedback]"
    value="<?php echo isset($this->options['govph_acc_link_feedback']) ?>">
<?php
  }
  ...
  ?>
<span class="field-prefix"><?php echo get_site_url(); ?>/ </span>
<input type="text" name="govph_options[govph_acc_link_faq]" value="<?php echo isset($this->options['govph_acc_link_faq']) ?>">
<?php
  }

  public function govph_acc_link_sitemap()
  {
    $value = isset($this->options['govph_acc_link_sitemap']) ? $this->options['govph_acc_link_sitemap'] : '#gwt-standard-footer';
  ?>
<span class="field-prefix">{current_url}/ </span>
...
<input type="text" name="govph_options[govph_acc_link_search]"
    value="<?php echo isset($this->options['govph_acc_link_search']) ?>"><br />
...
function govph_displayoptions( $options ){
  ...
  switch ($options) {
    case 'govph_logo_enable':
      ...
      break;
    case 'govph_agency_name':
        // Retrieve and echo the agency name
        $agencyName = isset($option['govph_agency_name']) ? $option['govph_agency_name'] : '';
        echo $agencyName;
        break;
    case 'govph_agency_tagline':
        // Retrieve and echo the agency tagline
        $agencyTagline = isset($option['govph_agency_tagline']) ? $option['govph_agency_tagline'] : '';
        echo $agencyTagline;
        break;
    case 'govph_logo_setting':
      ...
      case 'govph_logo':
        ...
        // Check if the logo is enabled and display it
        if (isset($option['govph_logo_enable']) && $option['govph_logo_enable'] == 1) {
            $addLogo = '<img src="'.$logo_image.'" />';
        } else {
            // Fetch agency name and tagline
            $agency_name = isset($option['govph_agency_name']) ? esc_html($option['govph_agency_name']) : '';
            $agency_tagline = isset($option['govph_agency_tagline']) ? esc_html($option['govph_agency_tagline']) : '';
      
            // Display the text-based logo with agency name and tagline
            $addLogo = '
            <div id="textlogo-wrapper">
              <div id="textlogo-image">
                <img alt="' . $agency_name . ' Official Logo" src="' . $logo_image . '" height="100px" width="100px"/>
              </div>
    ...
    case 'govph_background_header_size_setting':
      if (isset($option['govph_background_header_size']) && $option['govph_background_header_size'] == 'true') {
    ...
    case 'govph_disable_search':
      return (isset($option['govoh_disable_search']) && $option['govph_disable_search'] ? false  : true);
      break;
    ...
    case 'govph_enable_post_classic_editor':
      return (isset($option['govph_enable_widget_classic_editor']) && $option['govph_enable_post_classic_editor'] ? false  : true);
      break;
